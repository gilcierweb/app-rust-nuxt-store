...
impl Hooks for App {
    ...
    fn routes(_ctx: &AppContext) -> AppRoutes {
        AppRoutes::with_default_routes() // controller routes below
            .add_route(controllers::admin_audit_logs::routes())
            ...
            .add_route(controllers::address::account_routes())
            ...
            .add_route(controllers::review::account_routes())
            ...
            .add_route(controllers::profile::account_routes())
            ...
            .add_route(controllers::admin_payment_refunds::routes())
