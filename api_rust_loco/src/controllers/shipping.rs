...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
        ...
        item.base_price = Set(self.base_price);
        item.free_shipping_threshold = Set(self.free_shipping_threshold);
...
pub fn routes() -> Routes {
    routes_with_prefix("api/shippings/")
}

pub fn admin_routes() -> Routes {
    routes_with_prefix("api/admin/shippings/")
}
