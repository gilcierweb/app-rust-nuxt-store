  ...
  <div>
    ...
    <div class="mb-6 flex items-center justify-between">
      <div class="flex items-center gap-4">
        <NuxtLinkLocale to="/admin/addresses" class="btn btn-ghost btn-circle">
      ...
      <div v-if="address" class="flex gap-2">
        ...
        <NuxtLinkLocale :to="`/admin/addresses/${route.params.id}/edit`" class="btn btn-primary">
    ...
    <div v-else class="alert alert-warning">
      ...
      <NuxtLinkLocale to="/admin/addresses" class="btn btn-sm">Voltar para lista</NuxtLinkLocale>
    </div>
  </div>
</template>
