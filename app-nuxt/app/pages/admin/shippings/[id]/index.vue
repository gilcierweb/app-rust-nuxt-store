  ...
  <div>
    ...
    <div class="mb-6 flex items-center justify-between">
      <div class="flex items-center gap-4">
        <NuxtLinkLocale to="/admin/shippings" class="btn btn-ghost btn-circle">
      ...
      <div v-if="shipping" class="flex gap-2">
        ...
        <NuxtLinkLocale :to="`/admin/shippings/${route.params.id}/edit`" class="btn btn-primary">
    ...
    <div v-else class="alert alert-warning">
      ...
      <NuxtLinkLocale to="/admin/shippings" class="btn btn-sm">{{ t('admin.shippings.detail.back') }}</NuxtLinkLocale>
    </div>
  </div>
</template>
